...
class TaskDaoTestSuite {
    ...
    void testTaskDaoSaveWithFinancialDetails() {
        ...
        task.setFinancialDetails(new TaskFinancialDetails(new BigDecimal(120), false));
    ...
    void testTaskListDaoSaveWithTasks() {
        ...
        task.setFinancialDetails(tfd);
        task2.setFinancialDetails(tfd2);
    ...
    void testNamedQueries() {
        ...
        task1.setFinancialDetails(tfd1);
        task2.setFinancialDetails(tfd2);
        task3.setFinancialDetails(tfd3);
        task4.setFinancialDetails(tfd4);
